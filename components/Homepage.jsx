...
export default function Homepage() {
    return (
        <section className="h-screen">
            <NavBar />
            <div className="flex">
                <div className="text-white pt-6 lg:pt-10 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 font-normal leading-normal h-full">
                    <h1 className={`text-white font-GillSans text-5xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl ${luckyGuy.className}`}>
                        MUSIC <br /> REDEFINED
                    </h1>
                    <p className="text-gray-400 font-poppins text-lg sm:text-lg xl:text-xl w-full  pt-6">
                    ...
                    <div className="py-10 text-black flex flex-col sm:flex-row gap-4 sm:gap-16 text-lg sm:text-xl md:text-lg font-bold">
                        <button className="bg-[#A9FF5C] whitespace-nowrap py-2 px-6 rounded-md flex items-center gap-2">
                        ...
                        <button className="bg-[#CB5CFF] whitespace-nowrap rounded-md px-6 py-2 hover:cursor">
                            Contact Us
                        </button>
                    </div>
                </div>
                {/*grid section */}
                <div className="pt-6 lg:pt-10 flex flex-col gap-8">
                    <div className="flex justify-center gap-8 items-center ">
                        <img className="rounded-3xl w-1/3" src={'/sampleImage.jpg'} alt="sample img" />
                        <img className="rounded-3xl w-1/3" src={'/sampleImage.jpg'} alt="sample img" />
                    </div>
